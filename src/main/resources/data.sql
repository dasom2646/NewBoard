...
VALUES ( NEXTVAL('BOARD_SEQ')
       ...
       , '첫째 날, 홍콩 디즈니랜드에서의 시간은 아이와 함께 즐기는 재미로 가득 찼어요. ' ||
         ...
         '둘째 날은 홍콩 여행에서 정말로 특별한 하루였어요. 아침 일찍 나와 거리를 거닐며 현지 문화를 체험하는 것부터 시작했어요. 현지 시장에서의 재미난 구경과 로컬 음식들의 향기는 정말 놀라웠답니다.로컬 가게에서 맛본 홍콩 특유의 딤섬과 바게트는 제 입맛을 사로잡았어요. 현지인들과 함께 점심을 보내며 자연스럽게 소통하고 그들의 일상을 엿볼 수 있어서 더욱 의미 있는 시간이었어요.' ||
         '마지막 날, 빈폴리오 피크에서의 야경은 저에게 평생 잊지 못할 순간이었어요. 홍콩의 빛이 가득한 야경은 정말 환상적이었고, 그 순간을 사진에 담으며 영원한 추억으로 남겼어요.한국에서 홍콩까지의 비행시간은 짧아서 편안한 여행을 시작할 수 있었어요. 홍콩의 다양한 관광지와 현지 음식들을 맛보며, 그곳의 다양한 매력을 느낄 수 있었어요.' ||
         '가장 좋았던 곳은 홍콩의 거리 음식 문화였어요. 현지인들이 자주 찾는 로컬 식당에서 맛본 따뜻한 만두와 시원한 음료들은 정말로 맛있었고, 현지 문화를 더욱 느낄 수 있었어요.홍콩의 짧지만 풍성한 2박 3일은 정말로 특별한 경험이었어요. 이번 여행으로 홍콩의 아름다움과 다양한 매력을 느낄 수 있었고, 가족과 함께한 소중한 순간들을 영원히 기억하며 다음 여행을 기다리게 되었어요. '
       , CURRENT_TIMESTAMP
       , 0
       , '해외여행'
       , 1);
...
VALUES ( NEXTVAL('BOARD_SEQ')
       ...
       , '2020년 12월 25일 개봉한 픽스의 새로운 영화 ''소울''은 음악가의 꿈을 쫓는 주인공이 죽음과 삶 사이의 영혼의 세계를 여행하며 진정한 의미를 찾아가는 이야기입니다. ' ||
		 ...
		 '음악과 색감, 감동적인 이야기가 모두 완벽하게 어우러져 있었어요. 주인공의 내면의 탐색과 성장을 따라가며 저 또한 자신의 삶을 되돌아보게 되었어요. ' ||
